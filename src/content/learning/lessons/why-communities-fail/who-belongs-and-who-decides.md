---
type: lesson
title: Who belongs, and who decides that
slug: who-belongs-and-who-decides
...
They share a single missing thing — a stated answer to _what does this place actually require, and of whom_. Without it, the community defaults to the two worst options: enforcing nothing, or enforcing everything at once when it finally runs out of patience.
...
- **[The purpose that quietly changed](/learn/failures/mission-drift-competing-purposes)** — nobody voted to become something else, and enough people arrived wanting something else that it happened
- **[The norm nobody could enforce](/learn/failures/cultural-norm-violation-scope-test)** — a commitment central to the community's identity, with no process behind it
- **[Rules that spread into private life](/learn/failures/governance-creep-into-private-life)** — the opposite failure, and the one that makes members leave without complaining
- **[Removal with no process](/learn/failures/expulsion-without-due-process)** — grounds invented during the case they are used on
...
items={[
{
title: 'RCOS stress tests — Membership & Boundaries',
url: 'https://rcos.ecohubs.community/articles/rcos-stress-tests/membership-boundaries',
...
note: 'purpose, scope, and identity constraints that have to be testable'
},
{
...
note: 'membership states, rights and obligations, and the rules on exit'
},
{
...
note: 'community wealth as a lock-in device that raises the value of staying'
},
{
title: 'Membership: getting in, and getting out',
url: '/learn/guides/intentional-communities/membership-getting-in-and-out',
note: 'the joiner-facing version — the four stages and what a fair agreement contains'
}
]}
/>
