---
type: lesson
title: Conflict that never resolves
slug: conflict-that-never-resolves
...
- **[Conflict that is never named](/learn/failures/conflict-avoidance-normalization)** — the group is warm, nothing is confronted, and difficulty is absorbed until somebody leaves
- **[Punishment before repair](/learn/failures/punishment-before-repair)** — the group does act, and reaches straight for the consequence, so nobody raises anything small
...
That is the most misdiagnosed failure in this whole guide. The group concludes its process did not work and goes looking for a better method, when the problem was never the method. If that sounds familiar, [power nobody voted for](/learn/guides/why-communities-fail/power-nobody-voted-for) is the lesson you actually need.
...
items={[
{
title: 'RCOS stress tests — Conflict & Accountability',
url: 'https://rcos.ecohubs.community/articles/rcos-stress-tests/conflict-accountability',
note: 'the two documented patterns this lesson covers, in specification form'
},
{
...
note: 'conflict classes, the resolution ladder, safeguards and proportional sanctions'
},
{
title: 'Ostrom, E. — Governing the Commons (1990)',
url: 'https://doi.org/10.1017/CBO9780511807763',
note: 'graduated sanctions and cheap, local conflict resolution, among the eight design principles'
},
{
title: 'Conflict & repair',
url: '/learn/topics/conflict-resolution',
note: 'the five conflicts that actually recur, and what a repair process has to contain'
}
]}
/>
