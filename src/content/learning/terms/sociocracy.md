...
summary: A governance system organising a group into linked circles, each with its own domain, deciding by consent.
short: A governance system organising a group into linked circles, each with its own domain, deciding by consent.
targetQuery: what is sociocracy
status: published
updated: 2026-08-06
...
**Circles with real domains.** A circle is not a committee that recommends; it decides, within a boundary the wider group agreed. The kitchen circle does not bring the menu to the general meeting.
