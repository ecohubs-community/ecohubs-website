...
term: Exit clause
topic: resilience
summary: The written terms on which a member leaves, or the whole community winds itself up — agreed while everyone is still calm.
short: The written terms on which a member leaves, or the community winds itself up. Agreed while everyone is still calm, which is the only time it can be.
targetQuery: intentional community exit clause dissolution
status: published
updated: 2026-08-07
related: [membership-agreement, resale-formula, drift]
---
...
Knowing the exit terms is also protection for the person staying. A decision to remain in a difficult community is only a real decision if leaving is a real option — and leaving is only a real option if you know in advance what it costs.
